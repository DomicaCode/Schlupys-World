...
namespace Engine.Factories
{
    public static class ItemFactory
    {
        ...
        static ItemFactory()
        {
            _standardGameItems.Add(new Weapon(1001, "Udrimac", 1, 1, 2));
            ...
            _standardGameItems.Add(new GameItem(666, "Schlupy", 50));
            _standardGameItems.Add(new GameItem(123, "123", 50));
            _standardGameItems.Add(new Potion(69, "Potion 4", 30, 4));
            _standardGameItems.Add(new Weapon(30, "Mac", 10, 5, 10));
        }
